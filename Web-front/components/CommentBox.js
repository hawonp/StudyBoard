...
export const CommentBox = () => {
    ...
    const [comments, setComments] = useState([
        ...
        {id: 1, author: "landiggity", body: "This is my first comment on this forum so don't be a dick", replyComments: [
                {id: 11, author: "scarlett-jo", body: "That's a mighty fine comment you've got there my good looking fellow..."},
                {id: 22, author: "rosco", body: "That's a mighty fine comment you've got there my good looking fellow..."}
        ]},
        {id: 2, author: "scarlett-jo", body: "That's a mighty fine comment you've got there my good looking fellow...", replyComments: []},
        {id: 3, author: "rosco", body: "What is the meaning of all of this 'React' mumbo-jumbo?", replyComments: []}
    ])
    ...
    const _getComments = () => comments.map((comment) =>
        <Comment
    ...
    return (
        <div className="comment-box">
            ...
            <button style={{ float: 'right', margin:'1rem 1rem',
                backgroundColor: 'green', borderRadius: '4px', padding: '0.5rem 0.5rem',
                color: '#FFFFF'}} id="comment-reveal" onClick={toggleComments}>
                {buttonText}
            </button>
            <h3>Comments</h3>
            {/* 댓글 카운트 수 */}
        ...
        <>
            <div style={{diplay: 'flex'}} className="row">
                <div  style={{display: 'flex', flexDirection: 'column'}}>
                    <div style={{display: 'flex', paddingTop: '15px',borderBottom: '1px #ddd',paddingBottom: '20px'}} >
                        <img  style={{ borderRadius: '50%', width: '64px', height: '64px', border: '2px solid #e5e7e8'}} src="https://i.imgur.com/stD0Q19.jpg"/>
                        <div style={{display: 'flex', flex: 1, flexDirection: 'column', paddingLeft: '8px'}}>
                        ...
                        { author === userName && <div style={{marginRight: '20px'}}>
            ...
            <div>
                {replys && replys.map((reply) => <Reply key={reply} author={reply.author} body={reply.body} /> )}
            </div>
        </>
    );
}
...
const InputReply = ({ add, finish }) => {
    ...
    return (
        <div style={{display: 'flex', flex: 1, flexDirection: 'column', marginLeft: "4rem", alignItems: 'start'}}>
            <TextField fullWidth label="REPLY"
                       multiline
                       inputRef={inputRef}>
            </TextField>
            <div style={{ display: 'flex', width: "100%", justifyContent: 'end', marginTop: '0.5rem', marginBottom: '1rem'}}>
                <Button  sx={{borderRadius: '8px', height: '2rem', marginRight:'0.5rem'}}
                         variant="contained" color="error" onClick={finish}>
                    CANCEL
                </Button>
                <Button sx={{borderRadius: '8px', height: '2rem'}}
    ...
    return (
        <div className="media mt-4" style={{display: 'flex', marginLeft: "4rem"}}>
            <a className="pr-3" href="#">
                <img style={{ borderRadius: '50%', width: '64px', height: '64px', border: '2px solid #e5e7e8'}}  src="https://i.imgur.com/xELPaag.jpg"/>
            </a>
