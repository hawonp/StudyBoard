      ...
      >
        ...
        <div className={navStyles.box}>
          ...
          <p className={navStyles.line}>
            ...
            StudyBoard provides a system that gives quick answers to questions
            that users are curious about. The user can know by a notification
            when another user answers the question he or she wrote.
          </p>
          <p className={navStyles.line}>
          ...
          <p className={navStyles.line}>
            ...
            box, the user lists tags and posts. Users can see the writings they
            want at once.
          </p>
          <p className={navStyles.line}>
            <h2>Reliable</h2>
            ...
            the website. The user cannot know who reported who users are
          </p>
          <p className={navStyles.line}>
            <h2>Reduce your time and effort</h2>
            Users can get more answers with a single question. In addition,
            users can select the tags they want and collect and view only the
            tags they want. Users can see more questions and results in the
            filter section.
          </p>
        </div>
      </Box>
